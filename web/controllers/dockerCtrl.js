...
module.exports = {
    ...
    startBot: async function (req, res) {
        ...
        */
        ...
        let docker = new Dockerode();
        await docker.pull(opts.Image)
        docker.run(opts.Image, [], process.stdout, {name: opts.name, Hostname: opts.name, Cmd: 'freqtrade create-userdir --userdir user_data', Volumes: { '/freqtrade/user_data': {} }, ExposedPorts: { '8080/tcp': {} }, Cmd: 'trade -c config.json', HostConfig: { NetworkMode: 'freqtradenet', Binds: ['/root/trader_bot/web/freqtrade/user_data:/freqtrade/user_data']}}, function(err, data, container) {
