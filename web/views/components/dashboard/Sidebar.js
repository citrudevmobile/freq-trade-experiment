            ...
            <ul className="mt-3">
              ...
              {/* Strategies */}
                <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('strategies') && 'bg-slate-900'}`}>
                       <NavLink end to="/recipies"  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('strategies') && 'hover:text-slate-200'}`} >
