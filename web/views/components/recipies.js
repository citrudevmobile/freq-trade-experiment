                        ...
                        <div class="sm:px-6 w-full">
                            ...
                            <article class="md:gap-8 md:grid md:grid-cols-3 mb-4 rounded-lg border shadow-md p-10">
                                <div>
                                    ...
                                    <ul class="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                                        <li class="flex items-center"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>Profits: $100<span class="text-green-700 mx-1">(+62.10%)</span></li>
