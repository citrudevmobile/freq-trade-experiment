                                                    ...
                                                    <tr key={index} tabindex="0" class="mb-3 focus:outline-none h-16 border border-gray-100 rounded">
                                                        ...
                                                        <td class="pl-5">
                                                            <div class="flex items-center">
                                                                ...
                                                                <p class="text-sm leading-none text-gray-600 ml-2" ><span class="text-black">{val.trades.reduce( (accumulator, _val ) => { console.log(_val['profit_amount']); return accumulator + Number(_val['profit_amount'] || 0) }, 0) || 0}</span></p>
                                                            </div>
                                                        </td>
