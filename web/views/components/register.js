            ...
            <form class="bg-white" onSubmit={registerUser}>
              ...
              <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                  ...
                  <input class="pl-2 outline-none border-none" value={username} onChange={e => setUsername(e.target.value)} type="text" name="" id="" placeholder="Username" />
              </div>
                  <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none"
                      viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <input class="pl-2 outline-none border-none" value={email} onChange={e => setEmail(e.target.value)} type="text" name="" id="" placeholder="Email Address" />
              </div>
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                      ...
                      <input class="pl-2 outline-none border-none" value={password} type="text" name="" id="" placeholder="Password" />
              </div>
